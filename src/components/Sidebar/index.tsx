                ...
                <ul>
                    <li>
                        <div style={{ height: '22px', width: '22px' }}>
                            <SelectorSvg
                                fill={window.location.pathname === '/propose' ? colors.yellow : 'transparent'}
                            />
                        </div>
                    ...
                    <li>
                        <div style={{ height: '22px', width: '22px' }}>
                            <SelectorSvg
                                fill={window.location.pathname === '/new-farm' ? colors.yellow : 'transparent'}
                            />
                        </div>
                    ...
                    <li>
                        <div style={{ height: '22px', width: '22px' }}>
                            <SelectorSvg
                                fill={window.location.pathname === '/my-farm' ? colors.yellow : 'transparent'}
                            />
                        </div>
